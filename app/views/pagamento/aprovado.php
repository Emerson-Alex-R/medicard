    ...
    <div class="ugf-wrapper final-bg">
      <div class="final-content">
        ...
        <h2>Pagamento confirmado</h2>
          <p>A aquisição do seu <b><i>Plano Medicard</i></b> foi realizada com sucesso! <br/> Em breve nossa equipe entrará em contato.</p>
        <a href="passo-1.html" class="btn">Voltar ao site</a>
      </div>
    </div>
